    ...
    <div className="min-h-screen bg-gray-50 text-gray-800">
      ...
      <section className="py-16 px-6 bg-gray-50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <img
              src="https://images.pexels.com/photos/29871184/pexels-photo-29871184/free-photo-of-assorted-sushi-platter-with-vibrant-toppings.jpeg?auto=compress&cs=tinysrgb&w=800"
              alt="Signature Dish"
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden">
            <img
              src="https://images.pexels.com/photos/17593640/pexels-photo-17593640/free-photo-of-soup-with-egg.jpeg?auto=compress&cs=tinysrgb&w=800"
              alt="Signature Dish"
              className="object-cover h-48 w-full"
            />
            <div className="p-4">
      ...
      <section className="py-16 bg-gray-50 px-6">
        ...
        <div className="flex flex-col md:flex-row items-center max-w-4xl mx-auto">
          <img
            src="https://images.pexels.com/photos/9424913/pexels-photo-9424913.jpeg?auto=compress&cs=tinysrgb&w=800"
            alt="Chef's Special"
            className="rounded-lg shadow-lg w-full md:w-1/2 object-cover h-[300px]"
          />
          <div className="mt-6 md:mt-0 md:ml-8 text-center md:text-left">
            <h3 className="text-2xl font-bold">Wagyu Beef Nigiri</h3>
            <p className="text-gray-600 mt-2">
              A luxurious treat of seared Wagyu beef on a bed of seasoned sushi
              rice, topped with a touch of wasabi.
            </p>
          </div>
        </div>
      </section>
